...
export function EnrichmentInsights({ opportunity }: { opportunity: Opportunity }) {
  ...
  if (!hasInsights) {
    return (
      <div className="rounded-xl border border-dashed border-border/70 bg-card/30 p-6 text-center">
        ...
        <h3 className="mb-1 text-sm font-semibold tracking-tight">Unlock Deep Insights</h3>
        <p className="mb-4 text-xs text-muted-foreground max-w-[280px] mx-auto">
          Use AI to estimate application effort, competition intensity, and potential upside.
        </p>
        <Button
  ...
  return (
    <div className="space-y-6 rounded-xl border border-border/60 bg-card p-5 shadow-sm">
      <div className="flex items-center gap-2 border-b border-border/40 pb-3">
        ...
        <h3 className="text-sm font-semibold tracking-tight">Deep Factors</h3>
      </div>
